			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						...
						<li><a href="#"><i class="fa fa-envelope-o"></i> shopdetails@mail.ru</a></li>
						...
						<li><?php
                            ...
                            if(isset($_SESSION["uid"])){
                               ...
                               <div class="dropdownn">
                                ...
                                echo '
                                <div class="dropdownn">
                                  <a href="#" class="dropdownn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-user-o"></i> Профиль</a>
								  <div class="dropdownn-content">
								  	<a href="admin/login.php" ><i class="fa fa-user" aria-hidden="true" ></i>Админ</a>
                                    <a href="signin_form.php"><i class="fa fa-sign-in" aria-hidden="true" ></i>Авторизация</a>
                                    <a href="signup_form.php"><i class="fa fa-user-plus" aria-hidden="true"></i>Регистрация</a>
							...
							<div class="header-search">
								<form onsubmit="return false">
									<select class="input-select">
										...
										<option value="1">Комплектующие</option>
										<option value="1">Гарнитура</option>
									</select>
									<input class="input" id="search" type="text" placeholder="Найти">
									<button id="search_btn"   class="search-btn">Поиск</button>
								</form>
							</div>
						</div>
						<!-- /SEARCH BAR -->
							...
							<div class="header-ctn">
								...
								<div class="dropdown">
									...
									<div class="cart-dropdown"  >
										...
										<div class="cart-btns">
												<a href="cart.php" style="width:100%;"><i class="fa fa-edit"></i>Перейти в корзину</a>
