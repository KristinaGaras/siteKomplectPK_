							...
							<div class="col-md-5">
								<div class="product-details">
									...
									<ul class="product-btns">
										<li><a href="#" pid="'.$row['product_id'].'"  id="wishlist" ><i class="fa fa-heart-o"></i> Добавить в избранное</a></li>
						...
						<div id="product-tab">
							...
							<ul class="tab-nav">
								...
								<?php
												...
												echo '<li><a data-toggle="tab" href="#tab3">Похожие ('.$reviews_count.')</a></li>';
								?>
										...
										<div class="col-md-3 mainn">
											<div id="review-form">
												<form class="review-form" onsubmit="return false" id="review_form" required>
													...
													<button class="primary-btn" name="review_submit">Подписаться</button>
												</form>
											</div>
										</div>
										<!-- /Review Form -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title text-center">
							<h3 class="title">Остальные товары</h3>
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											...
											<button class='quick-view'><i class='fa fa-eye'></i><span class='tooltipp'>Следить</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
